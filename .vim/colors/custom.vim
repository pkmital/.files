...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    hi Normal         ctermbg=darkgray  ctermfg=250  guibg=darkgray guifg=#bcbcbc cterm=NONE           gui=NONE
    hi LineNr         ctermbg=darkgray  ctermfg=242  guibg=darkgray guifg=#6c6c6c cterm=NONE           gui=NONE
    ...
    hi MatchParen     ctermbg=231  ctermfg=131  guibg=NONE guifg=#ffffaf cterm=NONE           gui=NONE
    hi SignColumn     ctermbg=NONE  ctermfg=yellow  guibg=NONE guifg=#6c6c6c cterm=NONE           gui=NONE

  set background=dark

  hi Comment          ctermbg=NONE ctermfg=229   guibg=NONE    guifg=#58a058 cterm=NONE           gui=NONE
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
  ...
  hi Normal           guibg=darkgray      ctermbg=darkgray        ctermfg=white          cterm=NONE
  ...
  hi SignColumn       ctermbg=darkgrey    ctermfg=yellow      cterm=NONE
endif
