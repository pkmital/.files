...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
  hi Normal         ctermbg=235  ctermfg=250  guibg=#262626 guifg=#ababab cterm=NONE           gui=NONE
  ...
  hi Comment          ctermbg=NONE ctermfg=60  guibg=NONE    guifg=#8787af cterm=NONE           gui=NONE
  ...
  hi TabLineSel       ctermbg=101  ctermfg=235  guibg=#87875f guifg=#2626bc cterm=NONE           gui=NONE
  ...
  hi StatusLine       ctermbg=101  ctermfg=235  guibg=#87875f guifg=#2626bc cterm=NONE           gui=NONE
  ...
  hi WildMenu         ctermbg=110  ctermfg=235  guibg=#8fafd7 guifg=#2626bc cterm=NONE           gui=NONE
  ...
  hi IncSearch        ctermbg=131  ctermfg=235  guibg=#af5f5f guifg=#26aaaa cterm=NONE           gui=NONE
  hi Search           ctermbg=229  ctermfg=235  guibg=#ffffaf guifg=#26aaaa cterm=NONE           gui=NONE
